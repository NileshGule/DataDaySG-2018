...
Set-Location ~/projects/DataDaySG-2018/k8s/AKS

Write-Host "Creating namespace"  -ForegroundColor Yellow
kubectl apply --filename 00_DDNamespace.yml
...
Set-Location ~/projects/DataDaySG-2018/k8s/AKS/TechTalksDB
...
Set-Location ~/projects/DataDaySG-2018/k8s/AKS/TechTalksAPI
kubectl apply --recursive --filename . 
